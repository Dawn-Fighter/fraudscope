...
export function ThreatRadarChart() {
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 shadow-soft overflow-hidden h-[400px] flex flex-col relative group">
      {/* Background Glow */}
      ...
      <div className="p-5 border-b border-slate-100 relative z-10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-indigo-50 p-2.5 rounded-2xl text-indigo-600 shadow-sm border border-indigo-100">
      ...
      {/* Chart Area */}
      <div className="flex-1 p-2 relative z-10 min-h-0 flex flex-col">
