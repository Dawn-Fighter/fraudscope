...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("rounded-xl border border-slate-800 bg-[#0B101E]/90 backdrop-blur-xl text-slate-100 shadow-2xl relative overflow-hidden", className)} {...props} />
  )
)
